...
def testHandWritingClass():
    ...
    train_x = extract_images('D:/mnist/train-images-idx3-ubyte.gz', True, True)
    train_y = extract_labels('D:/mnist/train-labels-idx1-ubyte.gz')
    test_x = extract_images('D:/mnist/t10k-images-idx3-ubyte.gz', True, True)
    test_y = extract_labels('D:/mnist/t10k-labels-idx1-ubyte.gz')
